...
```
    You set turtle.Speed() to 10 which is the max.
```

2.d. How would you change the turtle's color to xanadu?

```
    You input turtle.pencolor(r,g,b) and you put the values for xanadu 
    into each of corresponding letters.
```

2.e. How would you fill a shape with the color xanadu?

```
    Make sure to incorporate screen.colormode(255) so that you can access the RGB
    colors then you could use turtle.color(r,g,b) -> turtle.begin_fill() -> turtle.end_fill().
```
