...
```
    fd() can be used as alternative besides turlte.forward().
```
...
```
    pos() can be used to print the turle's current location.
```

2.c. How do you set the turtle's speed to maximum speed?
   
```
    turtle.speed(0) will set the speed to the maximun speed.
```
