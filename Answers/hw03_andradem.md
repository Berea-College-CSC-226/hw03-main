...
1.a. Using the [RGB Color Wheel tool](https://colorspire.com/rgb-color-wheel/), create the color <span style="color:purple">purple</span>. 
...
1.b. Using the [RGB Color Wheel tool](https://colorspire.com/rgb-color-wheel/), create the color <span style="color:brown"> brown</span>. 
     What are the R, G, and B values? 
...
1.c. Using the [RGB Color Wheel tool](https://colorspire.com/rgb-color-wheel/), create the color <span style="color:MediumSeaGreen">xanadu</span>. 
     What are the R, G, and B values?

```
Never heard of this color before
rgb(8, 154, 129)
Oh, so like lichen color. Alright.
```
...
```
You can aparently use the shorthand fd(). Neat!
```
...
```
turtle.pos() returns postition, which can be printed.
```
...
```
turt.pencolor("xanadu")
```

2.e. How would you fill a shape with the color xanadu?

```
turt.fillcolor("xanadu")
turt.fill()
```
