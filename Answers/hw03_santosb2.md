...
```
    its like creating your own local copy of someones work. 
```
...
```
    I would say where your connectting it to for example like ours would be Github.
    When we create a copy it lives in our computer or whatever your using.
```
...
```
    Commit saves your chnages and comment is the reason behind your commit. 
```
...
```
    Its like pushing your work to the local work. So other people can see your progress 
    or what you've done on it. 
```
...
```
    So you and whoever your working with dont overite eachothers work. 
```
