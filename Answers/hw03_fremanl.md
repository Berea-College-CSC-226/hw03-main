...
```
    copying the repository to your device
```
...
```
    A space that contains all the files in your project. It exists on Git but once you clone it, it exists on your local 
    machine.
```
...
```
    A commit is when you tag your changes to the main repository and you need to tag them because it marks what you changed
```
...
```
   A push is when you push your changes to the main branch and it is pushed from your local device
```
...
```
    To make sure that there is no merge conflicts
```
...
```
    https://bereacs.slack.com/archives/C3QACGH8R/p1770866555866579
```
