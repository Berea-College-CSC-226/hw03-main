...
```
    (165, 42, 42) looks kind of red on the screen, haha!
```
...
```
   you could "import turtle as t" and use "t.fd()" for efficiency. 
```

2.b. Which command from the turtle library can be used to print the turtle's current location?

```
    to print turtles current location, use "pos()"
```
...
```
    you would first set the screen.colormode to 255 and then you could use
    the bgcolor feature and put the rbg specific color numbers. As so:
     wn.colormode(255)
    wn.bgcolor(187, 0, 255)
```

2.e. How would you fill a shape with the color xanadu?

```
    with fill(115, 134, 120)
```
