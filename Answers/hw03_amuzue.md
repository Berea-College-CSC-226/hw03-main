...
```
    Cloning the repo means downloading a copy of a project from GitHub to your computer.
```
...
```
    A repository is a place where a project’s files history are stored and it exists in Github.
```
...
```
    A commit saves your project at a specific point in time, and it needs a message so you and others know what changes
    were made.
```
...
```
    To push means to send your committed changes from your local repository to a remote repository.
```
