...
```
    You create your own copy of the repo on your device that you are using for coding.
```
...
```
    The repository is a file that contains all of the code that you have added to that repository. The repo shows all of your code and allows others to see your code for collaboration.
...
```
    A commit is an addition to to the pre-existing code that you are tranfering it to github so it is no longer just stored on your computer.
    A commit message is useful to see everything that has been done when you commit.
```
...
```
    The code is being pushed to your branch or main on github from your computer.
```
...
```
    To see other additions that other people have done and make sure your version on your computer matches the version on github minus your own additions that you havent pushed yet.
```
...
```
    There are 30 branches in the repo. I don't see my own because I haven't pushed yet but I can see other peoples branches.
```
